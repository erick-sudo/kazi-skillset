...
# #   Character.create(name: "Luke", movie: movies.first)
 ...
 200.times do
    ...
    Professional.create({
        ...
        email: "#{(fname+lname).downcase}@#{Faker::Internet.domain_name}",
         phone: rand(254700000000..254799999999),
         poster: "https://png.pngitem.com/pimgs/s/2-22912_laptop-girl-smile-woman-computer-female-young-girl.png",         category_id: rand(1..5),
 ...
 400.times do
    Review.create({
         job_id: rand(1..Job.count),         client_id: rand(1..Client.count),
